...
for root, dirs, files in os.walk("/home/ec2-user/McGill-Billboard"):
    iterationCount = 0
    successCount = 0
    for name in dirs:
        ...
        if spotify_id == None:
            ...
            current_file_path = '/home/ec2-user/songform-cmd/tmp/{}/'.format(artist[0])
            try:
                ...
                new_m4a_path = '/home/ec2-user/songform-cmd/data/audio/song{}.m4a'.format(successCount)
                print("M4A FILE: {}".format(m4a_file_path))

                shutil.copyfile(m4a_file_path, new_m4a_path)

                # Move corresponding text data to folder
                new_song_form_file_path = '/home/ec2-user/songform-cmd/data/text/song{}.txt'.format(successCount)
